...
<%@ page import="com.mlnxBBS.core.User"%>
<%@ page import="com.mlnxBBS.service.UserService"%>
<%@ page import="org.apache.struts2.ServletActionContext"%>
<%@ page import="javax.servlet.http.HttpServletRequest"%>
<%@ page import="com.mlnxBBS.core.HibernateSessionFactory"%>
	...
	if (contentType.indexOf("multipart/form-data") >= 0) {
		...
		while (fileItems.hasNext()) {
			...
			//如果是原始图片 file 域的名称或者以默认的头像域名称的部分“__avatar”打头(默认的头像域名称：__avatar1,2,3...，可在插件配置参数中自定义，参数名：avatar_field_names)
				...
				String virtualPath = avatarNumber + "_" + fileName;
		...
		User currUser = userService.findById(Integer.parseInt(String
