...
/**
 	* A data access object (DAO) providing persistence and search support for Navigation entities.
 			* Transaction control of the save(), update() and delete() operations 
		can directly support Spring container-managed transactions or they can be augmented	to handle user-managed Spring transactions. 
		Each of these methods provides additional information for how to configure it for the desired type of transaction control. 	
	 * @see com.mlnxBBS.core.Navigation
  * @author MyEclipse Persistence Tools 
 */
public class NavigationDAO extends BaseHibernateDAO  {
	     private static final Logger log = LoggerFactory.getLogger(NavigationDAO.class);
		//property constants
    ...
    public Navigation findById( java.lang.Integer id) {
        ...
        try {
            Navigation instance = (Navigation) getSession()
                    .get("com.mlnxBBS.core.Navigation", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List<Navigation> findByExample(Navigation instance) {
        ...
        try {
            List<Navigation> results = (List<Navigation>) getSession()
                    .createCriteria("com.mlnxBBS.core.Navigation")
                    .add( create(instance) )
            .list();
    ...
    public Navigation merge(Navigation detachedInstance) {
        ...
        try {
            Navigation result = (Navigation) getSession()
