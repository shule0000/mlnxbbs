...
/**
 	* A data access object (DAO) providing persistence and search support for Notice entities.
...
public class NoticeDAO extends BaseHibernateDAO  {
    ...
    public Notice findById( java.lang.Integer id) {
        ...
        try {
            Notice instance = (Notice) getSession()
                    .get("com.mlnxBBS.core.Notice", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public Notice merge(Notice detachedInstance) {
        ...
        try {
            Notice result = (Notice) getSession()
