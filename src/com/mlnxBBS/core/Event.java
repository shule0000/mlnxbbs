...
public class Event  implements java.io.Serializable {
	...
	/** minimal constructor */
    public Event(String etitle, String econtent, Integer epriority, Integer estatus) {
        this.etitle = etitle;
    ...
    /** full constructor */
    public Event(String etitle, String econtent, Timestamp etime, Integer epriority, Integer estatus) {
        this.etitle = etitle;
        this.econtent = econtent;
        this.etime = etime;
        this.epriority = epriority;
