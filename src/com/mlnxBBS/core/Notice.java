...
public class Notice  implements java.io.Serializable {
	...
	/** minimal constructor */
    public Notice(String ntTitle, String ntContent, Integer ntPriority, Integer ntStatus) {
    ...
    /** full constructor */
    public Notice(String ntTitle, String ntContent, Timestamp ntTime, Integer ntPriority, Integer ntStatus) {
        this.ntTitle = ntTitle;
        this.ntContent = ntContent;
        this.ntTime = ntTime;
        this.ntPriority = ntPriority;
